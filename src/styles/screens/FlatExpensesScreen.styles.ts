...
export const styles = (theme: Theme) => {
  ...
  participantPaymentAvatar: {
    width: sizes.s32,
    height: sizes.s32,
    borderRadius: semanticRadii.pill,
  },
  participantPaymentAvatarPlaceholder: {
    width: sizes.s32,
    height: sizes.s32,
    borderRadius: semanticRadii.pill,
    backgroundColor: colors.glassSurface,
